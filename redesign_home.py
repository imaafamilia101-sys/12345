...
<body class="home-redesign intro-complete">
  ...
  <main id="main">
    ...
    <section class="catalog-preview" id="catalog">
      <header class="catalog-preview__head reveal">
        ...
        <a href="catalog.html">СМОТРЕТЬ ВСЕ / {len(products)}</a>
      </header>
  ...
  <footer class="lux-footer">
    ...
    <div class="lux-footer__columns">
      <div><p>COLLECTION</p><a href="catalog.html">Смотреть все</a><a href="catalog.html?cat=bestseller">Bestseller</a><a href="https://hommeplusless.com/certificate" target="_blank" rel="noreferrer">Gift card</a></div>
