...
<head>
  ...
  <link rel="stylesheet" href="assets/styles.css?v=20260620-zipmacro1">
</head>
<body class="home-redesign intro-pending">
  <a class="skip-link" href="#main">К содержанию</a>
  <canvas id="diamond-field" aria-hidden="true"></canvas>

  <div class="diamond-intro zip-intro" data-diamond-intro aria-label="HOMME+LESS zip macro reveal" style="--intro-image: url(/{esc(image(hero, 1))}); --fabric-image: url(/{esc(image(hero, 0))})">
    <div class="zip-intro__model" aria-hidden="true"></div>
    <div class="zip-intro__macro" aria-hidden="true">
      <div class="zip-intro__fabric zip-intro__fabric--left"><i></i></div>
      <div class="zip-intro__fabric zip-intro__fabric--right"><i></i></div>
      <div class="zip-intro__track"><span></span><b><i></i></b></div>
    </div>
    <p class="diamond-intro__code">HM+LS / ZIP MACRO 01</p>
    ...
    <p class="diamond-intro__edition">UNZIP / MOSCOW</p>
  ...
  <script src="assets/app.js?v=20260620-zipmacro1"></script>
</body>
</html>"""
